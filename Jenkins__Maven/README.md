...
sudo ln -s $(ls | grep apache-maven*) maven                 # "ln -s" sembolik link yap anlamindadir. "Maven" yazinca buraya yönlendirir
...
- At `Post-build Actions` section,
  ...
  - For `Files to archive`, write `**/*.war`        # "**/*.war" tüm klasörler icinde ara ismi ne olursa olsun ve uzantisi ".war" olsun anlamindadir
